...
plt.fill_betweenx(y_40_sample, bootstrap_40_25, bootstrap_40_75, 
                ...
                alpha=0.65, label='40 nM bootstrap')
plt.fill_betweenx(y_160_sample, bootstrap_160_25, bootstrap_160_75,
                step='pre', facecolor='#D43124',
                alpha=0.65, label='160 nM bootstrap')
plt.step(x_80, y_80, label='80 nM', color='#753F98')
plt.xlabel('time (min)')
...
#%%
plt.figure(dpi=100)
plt.step(x_40, y_40, label='40 nM', color='#429447')
plt.step(x_80, y_80, label='80 nM', color='#753F98')
plt.step(x_160, y_160, label='160 nM', color='#D43124')
plt.xlabel('time (min)')
