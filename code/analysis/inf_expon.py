...
model = vdj.bayes.StanModel('../stan/expon_dwell_model.stan', force_compile=True)
...
samps.to_csv('../../data/expon_samples.csv', index=False)
stats = pd.concat(stats_df)
stats.to_csv('../../data/expon_summary.csv', index=False)
