...
# Restrict to mutants with 80 nM HMGB1 and Ca
data = data[(data['salt']=='Ca') & (data['hmgb1']==80)]
# %%
...
# %%
# Save things to disk
post_df.to_csv('../../data/ca_unlooping_rate_posteriors.csv', index=False)
stat_df.to_csv('../../data/ca_unlooping_rate_analytic_summary.csv', index=False)
